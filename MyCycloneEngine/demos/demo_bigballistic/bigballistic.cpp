...
#include "../MyCycloneEngine/ogl_headers.h"
#include "../MyCycloneEngine/app.h"
#include "../MyCycloneEngine/timing.h"
...
public:
	...
	void setState(ShotType shotType)
	{
		...
		case GRENADE:
			body->setMass(150); // 100KG
			body->setVelocity(0, 50, 50); // 30m/s
			body->setAcceleration(0, -21, 0);
			body->setDamping(0.99f, 0.8f);
			radius = 0.4f;
		}
